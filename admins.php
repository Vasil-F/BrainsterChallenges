...
<body>
    ...
    <div class="jumbotron text-center mb-0">
        ...
        <div class="container">
            <form method="POST" action="addModel.php" class="text-left font-weight-bold">
                <input type="hidden" name="action" value="model">
                <label class="mt-2" for="addModel">Add vehicle model</label>
                <input class="form-control w-50" type="text" name="addModel" id="addModel">
                <button class="btn btn-primary mt-3" type="submit" formaction="addModel.php" formmethod="POST">Add</button>
            </form>
        </div>
    </div>
