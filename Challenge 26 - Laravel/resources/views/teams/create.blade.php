...
<form class="w-2/3 mx-auto pb-5" action="{{ route('teams.store') }}" method="POST">
    @csrf
    <div class="mb-6">
    ...
    <div class="mb-6">
      ...
      <input type="date" id="founded_in" name="founded_in" value="{{ old('founded_in') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
    </div>
