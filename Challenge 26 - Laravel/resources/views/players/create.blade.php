...
@section('content')
    ...
    <div class="w-2/3 mx-auto mt-3 mb-5">
        <p class="py-10 text-xl italic">Create new player:</p>
    </div>
<form class="w-2/3 mx-auto pb-5" action="{{ route('players.store') }}" method="POST">
    @csrf
    <div class="mb-6">
    ...
    <div class="mb-6">
      ...
      <input type="text" id="surname" name="surname" value="{{ old('surname') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
    </div>
    <div class="mb-6">
      <label for="date_of_birth" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Date of birth</label>
      <input type="date" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth') }}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" >
    </div>
