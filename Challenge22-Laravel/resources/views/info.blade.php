...
<body class="100vh">
    ...
    <div class="container text-white pt-5">
        <h2 class="mt-5">Your name is : {{ session('name') }}</h2>
        <h2 class="mt-4">Your last name is : {{ session('surname') }}</h2>
        @if (!empty(session('email'))) 
        <h2 class="mt-4">Your email is : {{ session('email') }}</h2>
        @endif
    </div>

    <footer class="text-center text-white fixed-bottom">
        <p class="m-0 p-2">Copyright &copy Your Website 2018</p>
    </footer>
