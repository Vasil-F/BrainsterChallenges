...
<div class="flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
    ...
    <h2 class="text-2xl w-2/3 mx-auto mt-8">Edit discussion:</h2>
    ...
    <div class="w-2/3 h-full mx-auto mt-10 pb-10">
        <form method="POST" action="{{ route('discussions.update', $discussion->id) }}">
            ...
            <div class="mb-6">
                ...
                <input type="text" id="title" name="title" value="{{ $discussion->title }}"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                    placeholder="Title of discussion">
            </div>
            <div class="mb-6">
                <label for="photo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Photo</label>
                <input type="text" id="photo" name="photo" value="{{ $discussion->picture }}"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
            ...
            <div class="mb-6">
                ...
                <input type="text" id="description" name="description" value="{{ $discussion->description }}"
                    class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
            ...
            <select id="category" name="category"
                ...
                @foreach ($categories as $category)
                    <option value="{{ $category->id }}" @if((old('category_id') != null && old('category_id') == $category->id) || ($category->id == $discussion->category_id)) selected @endif > {{ $category->name }} </option>
                @endforeach
            </select>
            ...
            <button type="submit" formaction="{{ route('discussions.update', $discussion->id) }}"
                class="mt-8 mb-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Update
                discussion</button>
        </form>
