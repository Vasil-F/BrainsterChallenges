...
@section('content')
    ...
    <a href="{{ route('discussions.create') }}"
        ...
        class="text-white bg-gray-600 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 ml-4 mb-5 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">To dashboard</a>
        @endif
   

        @if (count($discussions) == 0)
        <h2 class="text-center text-2xl p-3 mt-4">Nothing here yet! Start a topic!</h2>
                ...
                <div class="flex flex-col justify-center content-end">
                    ...
                    <div class="my-2 text-right">
                        ...
                        <div class="text-right">
                            ...
                            <form class="inline" action="{{ route('discussions.approve', $discussion->id) }}" method="POST">
                                @csrf
                                @method('PUT')
                                <input type="hidden" value="1" name="approve">
                                 <button type="submit" title="Approve" formaction="{{ route('discussions.approve', $discussion->id) }}" class="inline mx-2"><i class="fa-solid fa-check"></i></button>
                            </form>
                            @endif
